...
def interpolate_vo_poses(vo_path, pose_timestamps, origin_timestamp, absolute_poses=False):
    ...
    return interpolate_poses(vo_timestamps, abs_poses, pose_timestamps, origin_timestamp, absolute_poses)


def interpolate_ins_poses(ins_path, pose_timestamps, origin_timestamp, use_rtk=False, absolute_poses=False):
    ...
    return interpolate_poses(ins_timestamps, abs_poses, pose_timestamps, origin_timestamp, absolute_poses)


def interpolate_poses(pose_timestamps, abs_poses, requested_timestamps_, origin_timestamp, absolute_poses=False):
